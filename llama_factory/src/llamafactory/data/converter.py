...
class AlpacaDatasetConverter(DatasetConverter):
    def __call__(self, example: dict[str, Any]) -> dict[str, Any]:
        ...
        output = {
            "ans_ids": example["ans_ids"] if "ans_ids" in example.keys() else None,
            "_loss_mask":example["token_mask"]  if "token_mask" in example.keys() else None,
            "_deltas":example["deltas"]  if "deltas" in example.keys() else None,
            "_prompt": prompt,
            "_response": response,
