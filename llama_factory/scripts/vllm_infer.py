...
def vllm_infer(
    ...
    #非训练情况下测试，需要添加新的token
    # print(model_args.model_name_or_path)
    # if "qwen3" in model_args.model_name_or_path.lower() and model_args.adapter_name_or_path is None:
    #      print(111222)
    ...
    engine_args = {
        ...
        "gpu_memory_utilization": 0.8 if '32B' in model_args.model_name_or_path else 0.85,
        "max_lora_rank":64,
    }
